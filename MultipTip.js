/* Multiple tipTip plugin based on <tipTip> http://code.drewwilson.com/entry/tiptip-jquery-plugin
 * Add Multiple tipTip support
 * by The Way you Can insert html markup tothe [title].So the tipTip will looks fantastic !
 */
(function($){
	$.fn.tipTip = function(options) {
		var defaults = { 
			id:'0',    //this is the key ,if you want multiple tipTip.make the id different.
			activation: "hover",
			keepAlive: false,
			maxWidth: "200px",
			edgeOffset: 3,
